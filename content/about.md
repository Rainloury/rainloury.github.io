...
我是 **Rainloury**，一个在武汉的职场爸爸，业余时间把家里那台群晖 DS923+ 玩成了小型 homelab。
...
所有配置命令都基于我的真实环境（`example.com` 域名、阿里云 DNS、华硕路由器 PPPoE）。**密码、AK/SK、IP、真实域名等敏感信息均用占位符**，具体值在我自己的运维 bundle 里，不会贴出来（联系方式见下，是故意留的）。

如果某篇文章帮到了你，或者发现我哪里写错了，欢迎在仓库提 issue。

- GitHub：[@rainloury](https://github.com/rainloury)
- 邮箱：<rainloury@gmail.com>
